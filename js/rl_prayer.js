document.addEventListener('DOMContentLoaded', function() {
    ...
    const prayerRequests = [
        {
            id: 1,
            title: "Healing for Team Member",
            team: "northside",
            description: "Please pray for John who is recovering from surgery. Doctors say recovery will take 6-8 weeks.",
            ...
            updates: [
                {
                    text: "John's surgery went well, now in recovery",
                    date: "2023-07-10",
                    user: "Sister Mary"
                }
            ]
        },
        {
            ...
            team: "rivervalley",
            description: "Pray for our outreach event next Saturday. We're expecting 100+ visitors from the community.",
            requester: "Brother David",
            date: "2023-07-08",
            status: "active",
            urgent: false,
            anonymous: false,
        ...
        },
        {
            ...
            team: "mountainview",
            description: "Several families in our team are facing financial difficulties. Pray for God's provision.",
            requester: "Anonymous",
            date: "2023-07-05",
            status: "active",
            urgent: false,
        ...
        {
            id: 4,
            title: "Youth Camp Preparation",
            team: "lakeside",
            description: "Pray for the youth camp preparations and for the hearts of the youth to be open.",
            requester: "Pastor Sarah",
            date: "2023-07-03",
            status: "active",
            urgent: false,
            anonymous: false,
            updates: [
                {
                    text: "All 30 spots have been filled!",
                    date: "2023-07-06",
                    user: "Pastor Sarah"
                }
            ]
        },
        {
            ...
            team: "centralcity",
            description: "Pray for wisdom as we make important decisions about our new building project.",
            requester: "Elder Michael",
            date: "2023-06-30",
            status: "active",
            urgent: true,
            anonymous: false,
        ...
        },
        {
            ...
            team: "northside",
            description: "Pray for the Smith family who are going through a difficult season of reconciliation.",
            requester: "Anonymous",
            date: "2023-06-28",
            status: "answered",
            urgent: false,
            ...
            updates: [
                {
                    text: "Family has begun counseling together",
                    date: "2023-07-02",
                    user: "Pastor John"
                },
                {
                    text: "Praise report! Family has reconciled!",
                    date: "2023-07-09",
                    user: "Sister Mary"
                }
            ]
    ...
    submitPrayerBtn.addEventListener('click', function(e) {
        ...
        const team = document.getElementById('prayer-team').value;
        ...
        filteredRequests.forEach(request => {
            ...
            prayerCard.innerHTML = `
                ...
                <div class="prayer-meta">
                    <span class="prayer-team">${getTeamName(request.team)}</span>
    ...
    function initChart() {
        ...
        const teamData = {
            northside: prayerRequests.filter(req => req.team === 'northside').length,
            rivervalley: prayerRequests.filter(req => req.team === 'rivervalley').length,
            mountainview: prayerRequests.filter(req => req.team === 'mountainview').length,
            lakeside: prayerRequests.filter(req => req.team === 'lakeside').length,
            centralcity: prayerRequests.filter(req => req.team === 'centralcity').length
        };
    ...
    function exportPrayerData() {
        const headers = ['ID', 'Title', 'Team', 'Status', 'Urgent', 'Requester', 'Date', 'Description'];
